...
namespace Ex04.Menus.Interfaces
{
    public class MainMenu
    {
        ...
        private void printMenu(SubMenuItem i_MenuToPrint, bool i_IsRoot)
        {
            ...
            Console.WriteLine(string.Format("Please enter your choice (1-{0} or 0 to {1}):",
                i_MenuToPrint.Children.Count, i_IsRoot ? "exit" : "go back"));
            Console.Write(">> ");
        }
        ...
        private int readChoice(int i_MaxOption, bool i_IsRoot)
        {
            ...
            while (!isValidInput)
            {
                ...
                if (!isValidInput)
                {
                    Console.WriteLine(string.Format("Please enter your choice (1-{0} or 0 to {1}):", i_MaxOption, i_IsRoot ? "exit" : "go back"));
                    Console.Write(">> ");
                }
            }
