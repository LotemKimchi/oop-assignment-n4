...
namespace Ex04.Menus.Interfaces
{
    ...
    public class SubMenu : MenuItem
    {
        ...
        public void Show(bool i_IsMainMenu = false)
        {
            ...
            while (keepRunning)
            {
                ...
                else
                {
                    ...
                    // אחרי פעולה - לעצור רגע כדי לראות פלט
        ...
        {
            // When you select a submenu — enter it (Back instead of Exit)
            Show(i_IsMainMenu: false);
        }
    ...
    public class ActionItem : MenuItem
    {
        ...
        public ActionItem(string i_Title, IMenuAction i_Action) : base(i_Title) 
        {
            if (i_Action == null)
            {
                throw new ArgumentNullException(nameof(i_Action));
            }
            r_Action = i_Action;
        }
    ...
    public class MainMenu
    {
        ...
        public void Show()
        {
            r_RootMenu.Show(i_IsMainMenu: true);
        }
    }
}
